...
void mm_free(void *bp)
{
	...
	//get size of block
	//Then use PUT in block pointer in and unallocted

	if(bp != NULL){

		size_t header_size = GET_SIZE(bp - WSIZE);
		//Put new bock with unallocated bit in old header block
		PUT(HDRP(bp), PACK(header_size, FREE_BLOCK )); 
